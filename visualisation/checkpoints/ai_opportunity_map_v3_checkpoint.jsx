...
function ScatterPlot({ computedUCs, colorMode, colorMap, highlightedUCIds, legendFilter, selectedUC, onSelectUC, T, enablerMap }) {
      ...
      <div style={{flex:1,display:"flex",overflow:"hidden"}}>
        <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
          <div style={{flex:1,position:"relative"}}>
            <ScatterPlot computedUCs={computedUCs} colorMode={colorMode} colorMap={colorMap} highlightedUCIds={highlightedUCIds} legendFilter={legendFilter} selectedUC={selectedUC} onSelectUC={id=>{setSelectedUC(id);if(id)setActivePanel("detail");}} T={T} enablerMap={enablerMap}/>
          </div>
